...
export const {setstate, settema, setdate, setmaster,setphone,setclient, setlocation,setpassword, setcity, setnikname, setprofile,setorder,setservice } = counterSlice.actions
