...
export const config = {
  matcher: ['/editprofile','/masterrecords','/calendar','/masterprofile/:path*','/api/get_messages','/api/get_orders_client', '/api/save_image','/api/set_patern', '/api/save_order','/clientprofile/:path']
};
