...
export const config = {
  matcher: ['/masterrecords','/calendar','/masterprofile/:path*','/api/get_messages','/api/get_orders_client', '/api/save_image','/api/set_patern', '/api/save_order','/clientprofile/:path']
};
